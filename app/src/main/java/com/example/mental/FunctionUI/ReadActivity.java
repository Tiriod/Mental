...
public class ReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        psychologyHealthBookItems.add(new BookItem(R.drawable.image_book_psychologyrulestheworld, "《心理学统治世界》", "心理学统治世界"));
        psychologyHealthBookItems.add(new BookItem(R.drawable.image_book_psychologyinlife, "《生活中的心理学》", "生活中的心理学"));
        psychologyHealthBookItems.add(new BookItem(R.drawable.image_book_hormonewar, "《荷尔蒙战争》", "荷尔蒙战争"));
        ...
        AIBookItems.add(new BookItem(R.drawable.image_book_rgzn1, "《人工智能简史》", "人工智能简史"));
        AIBookItems.add(new BookItem(R.drawable.image_book_rgzn2, "《人工智能的本质》", "人工智能的本质"));
        AIBookItems.add(new BookItem(R.drawable.image_book_rgzn3, "《智能时代》", "智能时代"));
        AIBookItems.add(new BookItem(R.drawable.image_book_rgzn4, "《科学预见人工智能》", "科学预见人工智能"));
        ...
        historyBookItems.add(new BookItem(R.drawable.image_book_globalhistory, "《全球通史》", "全球通史"));
        historyBookItems.add(new BookItem(R.drawable.image_book_shiji, "《史记》", "        《史记》系纪传体通史，一百三十卷，西汉司马迁著，约成书于西汉武帝征和年间。“史记”一词，东汉之前乃一切史书之统称，后始为司马迁史书之专称，原书最初被称作《太史公书》，到东汉桓帝才改称为《史记》。此书体例为纪传体之滥觞，分为十二本纪、十表、八书、三十世家、七十列传，以纪和列传为主体，故名纪传体，记载了上自黄帝，下至汉武征和三年三千年的历史。司马迁撰写《史记》的目的在于“究天人之际，通古今之变，成一家之言”，“原始察终，见盛观衰”。\n      司马迁，字子长，左冯翊夏阳人，博学多闻， 遍游名山大川，曾从当时著名学者孔安国学过《尚书》等，其父司马谈立志要写一部全面系统的史书，无奈生年有限，遗命司马迁完成。元封三年，迁为太史令，主管文史资料和天文历法，五年后，着手撰写《史记》。\n     然世事难测，天汉二年，汉将李陵投降匈奴，迁向武帝表示应客观评价李陵功过，因而身陷囹圄，惨遭宫刑。这不仅是肉体上的摧残，更是精神上的凌辱，司马迁不堪此冤，甚至想离开人世，但想到自己的史书“草创未就”，不甘心半途而废，权衡之后，决心忍辱苟活也要完成自己的事业，是以“就极刑而无愠色”，《史记》的写作，直至临终才搁笔。\n     以个人力量编写纵贯中国整个上古时代的通史，几千年来，无出其右者。司马迁不以成败论英雄，而以人格的魅力作为抑扬的标准。例如对于失败者项羽，司马迁赋予了种种悲剧英雄人格力量，写项羽之神勇，诸侯将“莫敢仰视”，写虞姬项羽之别，悲歌和应，更是千古离别之冠，赚尽诗人才子笔墨，荡尽失意之人哀肠。这使《史记》不仅成为史书之典范，也是不朽的文学名著，鲁迅先生赞其为“史家之绝唱，无韵之离骚。”"));
        historyBookItems.add(new BookItem(R.drawable.image_book_zizhitongjian, "《资治通鉴》", "资治通鉴"));
        historyBookItems.add(new BookItem(R.drawable.image_book_historyofthedeclineandfalloftheromanempire, "《罗马帝国衰亡史》", "罗马帝国衰亡史"));
        historyBookItems.add(new BookItem(R.drawable.image_book_nationalhistoryoutline, "《国史大纲》", "书名8"));
        historyBookItems.add(new BookItem(R.drawable.image_book_wanqingqishinian, "《晚清七十年》", "晚清七十年"));
        ...
        classicsBookItems.add(new BookItem(R.drawable.image_book_wzqy, "《物种起源》", "物种起源"));
        classicsBookItems.add(new BookItem(R.drawable.image_book_jzl, "《君主论》", "君主论"));
        classicsBookItems.add(new BookItem(R.drawable.image_book_szbf, "《孙子兵法》", "孙子兵法"));
